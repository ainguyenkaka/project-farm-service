...
public class MailService {
    ...
    public void sendCreationEmail(User user) {
        ...
        Locale locale = Locale.forLanguageTag(LANG_KEY);
    ...
    @Async
    public void sendPackageEmail() {
        String email = applicationProperties.getMail().getTo();
        log.debug("Sending package email to '{}'",email);
        Locale locale = Locale.forLanguageTag(LANG_KEY);
        Context context = new Context(locale);
        context.setVariable(BASE_URL, applicationProperties.getMail().getBaseUrl());
        String content = templateEngine.process("packageEmail", context);
        String subject = messageSource.getMessage("email.package.title", null, locale);
