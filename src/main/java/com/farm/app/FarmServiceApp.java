...
import com.farm.app.config.ApplicationConstants;
...
public class FarmServiceApp {

    private static final Logger log = LoggerFactory.getLogger(FarmServiceApp.class);

    private final Environment env;

    public FarmServiceApp(Environment env) {
        this.env = env;
    }
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(FarmServiceApp.class);
